...
> 3) &nbsp; bedtools coverage -a Anchor2.bed -b out.spet.bed3 > self2.bed <br />
...
### Result file
We will get the result file named *out_significant_interaction.txt*. 
chrom1|	start1|	end1|	chrom2|	start2|	end2|	ipet1| ipet2|	Normalized ipet1|	Normalized ipet2|	P-value|	p.adjust|	intensity type|
|-------|-------|------|------|--------|------|-------|---------|-------|----------|-------|-------|------|
|chr1	|39648742	|39652714	|chr1	|39654893	|39662163	|4| 15	|3.83360974|	15.20362117|	0.000798074	|0.022997704	|2|
...
- **ipet1:** Number of PETs between clusters in sample-1 <br />
- **ipet1:** Number of PETs between clusters in sample-2 <br />
